...
class CoreWebView2(Object):
	...
	def RemoveScriptToExecuteOnDocumentCreated(self, id: str) -> None: ...
	...
	def ExecuteScriptAsync(self, script: str) -> Task[str]: ...
...
class CoreWebView2Environment(Object):
	# incomplete
	@classmethod
	def SetLoaderDllFolderPath(cls, folderPath: str) -> None: ...